...
export const jaJP = {
  ...
  seo: {
    ...
    characterDetail: { title: "キャラクター詳細", description: "Our Notes キャラクター詳細ページ基盤。" },
    cards: { title: "カード", description: "Our Notes カードページ基盤。" },
    cardDetail: { title: "カード詳細", description: "Our Notes カード詳細ページ基盤。" },
