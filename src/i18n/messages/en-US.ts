...
export const enUS = {
  ...
  settings: {
    ...
    breadcrumbDropdown: "Breadcrumb menus",
  ...
  seo: {
    ...
    characterDetail: { title: "Character detail", description: "Our Notes character detail page foundation." },
    cards: { title: "Cards", description: "Our Notes card page foundation." },
    cardDetail: { title: "Card detail", description: "Our Notes card detail page foundation." },
