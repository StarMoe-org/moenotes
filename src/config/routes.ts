  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: "live2d-viewer",
        seo: {
          titleKey: "seo.live2dViewer.title",
          descriptionKey: "seo.live2dViewer.description",
          keywords: ["Our Notes Live2D", "BanG Dream Live2D viewer", "Live2D model viewer", "character costumes", "story motions and expressions"],
          sitemap: { priority: 0.5, changefreq: "weekly" },
        },
        nav: { order: 20, icon: "users" },
        searchable: true,
